      ...
      <div className="about-me__container">
        ...
        <div className="about-me__info-container">
          <div className="about-me__info">
            ...
            <p className="about-me__text">Я получила высшее образование в Орловском государственном университете по
              специальности «Документоведение и документационное обеспечение управления», но меня всегда очень привлекало
              программирование. В ноябре 2022 года закончила обучение в Яндекс.Практикуме на фронтенд-разработчика.
              На данный момент я живу в Грузии. Хочу связать свою дальнейшую карьеру с программированием.</p>
